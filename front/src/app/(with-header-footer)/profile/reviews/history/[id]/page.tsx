...
import { MoreVertical, SquarePen, ThumbsUp, Trash } from "lucide-react";
...
const ReviewDetail = () => {
    ...
    const isOwner = review && user?.user_id && review.user_id === user.user_id;
        ...
        <div>
            ...
            <div className="space-y-4">
                {!review ? (
                    ...
                    <div className="bg-white rounded-lg px-3 py-2.5 border border-border-default">
                ...
                <div className="flex flex-col gap-2">
                    <button
                        onClick={() => {
                            ...
                            router.push(`/profile/write-review/edit/${reviewId}`);
                        }}
