...
const PhoneNumber = ({ handleInputChange, formData, isPhoneVerified, setIsPhoneVerified }: { handleInputChange: (key: string, value: string) => void, formData: any, isPhoneVerified: boolean, setIsPhoneVerified: (value: boolean) => void }) => {
        ...
        <div className="mb-4">
            ...
            <div className="flex gap-1">
                ...
                <button
                    ...
                    onClick={() => getVerificationCode({ phone_number: formData.phone, purpose: 'SIGNUP', "user_id": 0 })}
                >
