const KakaoLoginBtn = () => {
    ...
    const REDIRECT_URI = process.env.NEXT_PUBLIC_KAKAO_REDIRECT_URI_EVENT || "";
    ...
    return (
        <button onClick={handleKakaoLogin} className="btn-primary-empty w-full text-center mb-2 bg-[#FEE500]! text-gray-0! flex items-center justify-center gap-3">
